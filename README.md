...
This project started in December 2021 as part of the Microsoft's Future Ready Talent program. App resources and pull requests are maintained and reviewed by a team of volunteers. Learn more about the features of Kiwi app v1.0.1 here. Upcoming updates will include more app features, support for admin logIn, and chat support through power virtual agent.
